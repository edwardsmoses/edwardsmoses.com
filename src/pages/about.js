  ...
  return (
    <Layout>
      <SEO
        ...
        pageType="AboutPage"
      />
      <div className="about-page relative px-0 sm:px-8 lg:px-12">
            ...
            <div className="lg:pl-20">
              <div className="max-w-xs px-2.5 lg:max-w-none">
                <img
                  ...
                  className="object-cover aspect-square rounded-2xl bg-zinc-100 image-outline shadow-2xl shadow-zinc-900/10"
                  loading="lazy"
                />
              </div>
            </div>
