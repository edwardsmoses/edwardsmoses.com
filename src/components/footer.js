      ...
      <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:flex md:items-center md:justify-evenly lg:px-8">
        <div className="flex justify-center space-x-4 md:order-3">
          ...
          >
            ...
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 transition ">
          ...
          >
            ...
            <svg viewBox="0 0 24 24" aria-hidden="true" fill="currentColor" className="w-6 h-6 transition">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
          ...
          >
            ...
            <img src="/assets/duolingo.svg" alt="" className="w-6 h-6" />
          </a>

          <a
            href="https://app.codecrafters.io/users/edwardsmoses"
            target="_blank"
            className="text-gray-400 dark:text-white hover:text-gray-500"
          >
            <span className="sr-only">CodeCrafters</span>

            
            <img src="https://app.codecrafters.io/assets/7408d202b2bb110054fc.svg" alt="" className="w-6 h-6" />
          </a>
