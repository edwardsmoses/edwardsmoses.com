    ...
    <>
      <section id="info" className="my-14">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div
            className="relative px-4 py-20 overflow-hidden bg-indigo-50 sm:-mx-6 sm:px-6 md:mx-0 md:px-16 xl:px-24 xl:py-36"
            style={{
              borderRadius: "2.5rem",
            }}
          >
                  ...
                  <div className="max-w-2xl">
                    ...
                    <div className="mt-5">
                      ...
                      >
                        <li className="flex ">
                          <a
                            className="flex text-sm font-medium text-blue-800 transition group hover:text-blue-900"
                        ...
                        <li className="flex">
                          <a
                            className="flex text-sm font-medium text-blue-800 align-middle transition group hover:text-blue-900"
