    ...
    <>
      <section id="info" className="my-14">
        <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="info-panel relative px-5 py-16 overflow-hidden sm:-mx-6 sm:px-8 md:mx-0 md:px-16 xl:px-24 xl:py-28">
            <canvas id="gradient-canvas" data-transition-in />

            <div className="relative grid max-w-2xl grid-cols-1 mx-auto gap-x-32 gap-y-14 xl:max-w-none ">
              <div>
                <div className="max-w-2xl mx-auto lg:max-w-5xl">
                  <div className="max-w-2xl">
                    <a aria-label="Home" className="block w-20 h-20 origin-left pointer-events-auto" href="/">
                      <img
                        src="/assets/i.JPG"
                        alt="Edwards Moses - Web & Mobile — React & React Native Consultant"
                        className="object-cover w-20 h-20 bg-blue-900 rounded-full image-outline"
                      />
                    </a>

                    <h2 className="text-4xl font-bold tracking-tight text-blue-950 text-balance sm:text-5xl">
                      Edwards Moses <br />
                      Web & Mobile — React & React Native Consultant
                    </h2>
                    <p className="mt-6 text-base leading-7 text-blue-950 text-pretty info-blurb-info-about-me">
                    ...
                    <div className="mt-5">
                      <ul className="flex flex-col space-x-0 space-y-3 lg:flex-row lg:space-y-0 lg:space-x-4">
                        <li className="flex ">
                          <a
                          ...
                          >
                            ...
                            <span className="self-center ml-1">GitHub</span>
                          </a>
                        </li>
                        ...
                        <li className="flex ">
                          <a
                            ...
                            rel="noreferrer"
                          >
                            <svg viewBox="0 0 24 24" fill="currentColor" className="flex-none w-6 h-6">
                              <path d="M18.335 18.339H15.67v-4.177c0-.996-.02-2.278-1.39-2.278-1.389 0-1.601 1.084-1.601 2.205v4.25h-2.666V9.75h2.56v1.17h.035c.358-.674 1.228-1.387 2.528-1.387 2.7 0 3.2 1.778 3.2 4.091v4.715zM7.003 8.575a1.546 1.546 0 01-1.548-1.549 1.548 1.548 0 111.547 1.549zm1.336 9.764H5.666V9.75H8.34v8.589zM19.67 3H4.329C3.593 3 3 3.58 3 4.297v15.406C3 20.42 3.594 21 4.328 21h15.338C20.4 21 21 20.42 21 19.703V4.297C21 3.58 20.4 3 19.666 3h.003z"></path>
                            </svg>
                            <span className="self-center ml-1">LinkedIn</span>
                          </a>
                        </li>
                        ...
                        <li className="flex">
                          ...
                          >
                            ...
                            <span className="self-center ml-1">Twitter</span>
                          </a>
                        </li>

                        <li className="flex dark:border-zinc-700/40">
                          <a
                            className="info-social-link"
                          ...
                          >
                            ...
                            <span className="self-center ml-1">hi@edwardsmoses.com</span>
                          </a>
                        </li>
                      </ul>
                    </div>
