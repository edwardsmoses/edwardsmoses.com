...
export const Hero_WorkWithMe = () => {
  ...
  return (
    <div className="hero-intro">
      ...
      <h1
        className="max-w-4xl mx-auto mt-0 text-5xl font-medium tracking-tight text-balance font-display sm:text-7xl"
        style={{ lineHeight: 1.1 }}
      >
        I help companies{" "}
        <span className="relative text-app-brand-yellow dark:text-[#d8bb7b] sm:whitespace-nowrap">
          <span className="relative">build and design</span>
        </span>{" "}
        software.
      </h1>
